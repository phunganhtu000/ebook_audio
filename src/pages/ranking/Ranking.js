                                ...
                                renderItem={({item, index}) => (
                                    <TouchableOpacity
                                        ...
                                        <View style={styles.viewText}>
                                            ...
                                            <TextComponent
                                                style={[styles.texttag, {color: ThemeConstants[theme].textColor, ...marginTop10}]}>{item.author_name}</TextComponent>
...
export default connect(mapStateToProps, {getLatest, darkMode})(Ranking);
