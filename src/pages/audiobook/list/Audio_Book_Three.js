                                        ...
                                        <FastImage style={styles.image}
                                            ...
                                            <View style={styles.viewPlay}>
                                                ...
                                                <View style={styles.itemPlay}>
                                                    <TextComponent
                                                        style={styles.title}>{item.book_title}</TextComponent>
                                                    <View style={{...rowView}}>
                                                        <TextComponent
                                                    ...
                                                    renderItem={({item}) => (
                                                        <TouchableOpacity
                                                            ...
                                                            <View style={styles.viewText}>
                                                                <TextComponent
                                                                    style={[styles.text2, {color: ThemeConstants[theme].textColor}]}>{item.book_title}</TextComponent>
                                                                <TextComponent
...
export default connect(mapStateToProps, {getDetail, darkMode})(AudioBookThree);
