        ...
        <ScrollView>
          <View style={styles.body}>
            ...
            <TouchableOpacity
              ...
              <View>
                <TextComponent style={styles.name}>Việt Jye</TextComponent>
            ...
            <TouchableOpacity
              ...
              <View>
                <Icon name='questioncircleo' type='AntDesign' style={styles.icon}/>
              </View>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => this.openWeb()}
            ...
            <TouchableOpacity
              ...
              <View>
                <Icon name='message1' type='AntDesign' style={styles.icon}/>
              </View>
            </TouchableOpacity>
            {/*<TouchableOpacity*/}
